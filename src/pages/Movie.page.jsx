        ...
        <>
            ...
            <div className=" my-12 container px-4 lg:ml-20 lg:w-2/3">
                <div className="flex-flex-col items-start gap-3">
                    <h2 className="text-gray-800 font-bold text-2xl lg:mb-1">About the movie</h2>
                    <p>{movie.overview}</p>
                </div>
                <div className="my-8">
                    <hr />
                ...
                <div className="my-8">
                    ...
                    <div className="flex flex-col gap-3 lg:flex-row">
                        <div className="flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md">
                            <div className="w-8 h-8"><FaCcVisa className="w-full h-full" /></div>
                                <div className="flex flex-col items-start">
                                    <h3 className="text-gray-700 font-bold">Visa Stream Offer</h3>
                        ...
                        <div className="flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md">
                            <div className="w-8 h-8"><FaCcApplePay className="w-full h-full" /></div>
                                <div className="flex flex-col items-start">
                                    <h3 className="text-gray-700 font-bold">Filmy Pass</h3>
                    ...
                    <div className="my-8">
                        <PosterSlider config={settings} images={recommended} title="BMS Exclusive" isDark={false} />
